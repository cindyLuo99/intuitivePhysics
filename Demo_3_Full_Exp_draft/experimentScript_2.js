document.addEventListener("DOMContentLoaded", function () {
    ...
    // Shuffle time constraints (2 blocks for each time constraint)
    ...
    // Function to calculate and log the current FPS
    function logFPS() {
        if (runner.frameDelta) {
    ...
    var beforeYouBegin = {
        ...
        pages: [
            ...
            '<ul>'+
              '<li style="text-align: left;">For <b>Mac Users</b>: <b>Safari</b> is our recommended browser for this experiment.</li>'+
              '<li style="text-align: left;">For <b>Windows Users</b>: <b>Edge</b> is our recommended browser.</li>'+
              '<li style="text-align: left;"><b>Alternative Option</b>: <b>Google Chrome</b> is also an acceptable browser for participation.</li>'+
            '</ul>'
    ...
    var instructions = { 
        ...
        pages: [ // should be an array here
            ...
            '<p>In this experiment, there are 144 short videos. Each video is 3 seconds long. The study is expected to take 25 minutes.</p>'+
    ...
    var fallingObjectTrial_prac = {
        ...
        data: {
            // runnerFPS: 0, // update in matter.js 0.20.0
...
//////// ---- above are modified 12/2/24
    ...
    var instructions_timeLimit = { 
        ...
        pages: [ // should be an array here
            ...
            '<p><b>A countdown timer</b> <img src = "countdown_Timer.png" style="width: 15%; vertical-align: middle;"></img> will be visible at the top right of the screen ' +
    ...
    var start_practice_timed = {
        ...
        pages: [
            ...
            "<p>To help you get more comfortable with the task, let's begin with some practice trials first!</p>"+
