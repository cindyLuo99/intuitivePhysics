document.addEventListener("DOMContentLoaded", function () {
    ...
    // var full_design = jsPsych.randomization.factorial({first: fallingScene_info, second: reconstructionTask_info}, 1).slice(0,10);
    ...
    var praticeTrial = {
        ...
        stimulus: "<br>Remember! After a ball falls, the screen will disappear, and you'll guess where the triangle was."+ 
        "<br>You'll enter your guess by dragging a triangle, and clicking 'Submit'." + 
        "<br>Let's practice moving the triangle around!" +  
        "<br>Please drag the triangle below, then click 'Submit'.",
        choices: 'NO_KEYS',
        on_start: function() {
