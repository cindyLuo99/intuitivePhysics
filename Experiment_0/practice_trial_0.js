document.addEventListener("DOMContentLoaded", function () {
    ...
    const canvasWidth = 1000,
          ...
          ball_Y = 50,
          obstacle_X = canvasWidth / 2 + 40,
          obstacle_Y = occluderHeight + 20;
    // Prompt
    ...
    function setupFallingObjectTrial() {
        ...
        var occluder = Bodies.rectangle(occluder_X, occluder_Y, occluderWidth, occluderHeight, {
            ...
            render: {
                // fillStyle: colorA,
                // if changes opacity & adding shading texture
                fillStyle: 'rgba(191,197,207,0.25)',
                visible: true,
                // if without occluder
                // visible: false
            }
