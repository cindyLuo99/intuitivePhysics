document.addEventListener("DOMContentLoaded", function () {
    ...
    var practiceTrial_withOccluder_intro = {
        ...
        stimulus: "<p>To help you get comfortable with the task, let's start with a practice trial first!</p>"+
                    "<p>As described previously, you will first see a video of a ball falling, some of it behind a gray screen.</p>"+
                    "<p>After the video, you will drag a triangle to where you think the ball hit the triangle behind the screen.</p>"+
                    "<p>Click 'Next' to start the practice trial.</p>",
        choices: ['Next'],
    };
    ...
    var practiceTrial_withOccluder_fall = {
        ...
        on_finish: function(trial){
            jsPsych.data.addDataToLastTrial({
                ...
                obstacle_X_prac_occ,
                obstacle_Y_prac_occ,
                trial_cate: 'fallScene_practiceTrial_withOccluder'
            })
          }
    }
    ...
    var practiceTrial_withOccluder_reconstruct = {
        ...
        on_finish: function() {
            jsPsych.data.addDataToLastTrial({
                ...
                trial_cate: 'reconstruct_practiceTrial_withOccluder'
            })
            var existingMainContainer = document.getElementById('main-container_task');
            if (existingMainContainer) {
                existingMainContainer.remove();
